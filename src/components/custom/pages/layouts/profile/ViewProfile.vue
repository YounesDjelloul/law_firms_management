...
const currentUserDetails = userSession.cookies.get('user')

const userBio = shared.objectPop('bio', currentUserDetails)
          ...
          <div class="profile-card">
            <div class="profile-card-section">
              ...
              <div class="section-content">
                <p v-if="userBio" class="description">{{ userBio }}</p>
                <p v-else class="description">No bio yet!</p>
              </div>
            </div>
          </div>
            ...
            <div class="profile-card-section">
              ...
              <div class="section-content">
                <div class="skills-wrapper">
                  <div
                    v-for="(detailInfo, detailIndex) in currentUserDetails"
                    class="skills-item"
                  >
